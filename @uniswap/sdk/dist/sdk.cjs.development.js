...
var WETH = (_WETH = {}, _WETH[exports.ChainId.NOVA] = /*#__PURE__*/new Token(exports.ChainId.NOVA, '0x657a66332A65B535Da6C5d67b8cD1D410c161a08', 18, 'WSNT', 'Wrapped SNT'), _WETH[exports.ChainId.FANTOM] = /*#__PURE__*/new Token(exports.ChainId.FANTOM, '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83', 18, 'WFTM', 'Wrapped FTM'), _WETH[exports.ChainId.NEBULA] = /*#__PURE__*/new Token(exports.ChainId.NEBULA, '0x7e2D6Ac6cEAAa20a3Cc4CA4c1b0dFC6b95332A9d', 18, 'WNBK', 'Wrapped NBK'), _WETH);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || (input === ETHER || input === FANTOM || input === NBX) && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || (output === ETHER || output === FANTOM || output === NBX) && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
function wrappedAmount(currencyAmount, chainId) {
  ...
  if (currencyAmount.currency === ETHER && chainId === exports.ChainId.NOVA || currencyAmount.currency === FANTOM && chainId === exports.ChainId.FANTOM || currencyAmount.currency === NBX && chainId === exports.ChainId.NEBULA) return new TokenAmount(WETH[chainId], currencyAmount.raw);
    invariant(false, 'CURRENCY')  ;
}

function wrappedCurrency(currency, chainId) {
  if (currency instanceof Token) return currency;
  if (currency === ETHER && chainId === exports.ChainId.NOVA || currency === FANTOM && chainId === exports.ChainId.FANTOM || currency === NBX && chainId === exports.ChainId.NEBULA) return WETH[chainId];
    invariant(false, 'CURRENCY')  ;
}
/**
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === ETHER && route.chainId === exports.ChainId.NOVA ? CurrencyAmount.ether(amounts[0].raw) : route.input === FANTOM && route.chainId === exports.ChainId.FANTOM ? CurrencyAmount.fantom(amounts[0].raw) : route.input === NBX && route.chainId === exports.ChainId.NEBULA ? CurrencyAmount.nebula(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === ETHER && route.chainId === exports.ChainId.NOVA ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : route.output === FANTOM && route.chainId === exports.ChainId.FANTOM ? CurrencyAmount.fantom(amounts[amounts.length - 1].raw) : route.output === NBX && route.chainId === exports.ChainId.NEBULA ? CurrencyAmount.nebula(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance, chainId) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof TokenAmount ? new TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut) : chainId === exports.ChainId.FANTOM ? CurrencyAmount.fantom(slippageAdjustedAmountOut) : chainId === exports.ChainId.NEBULA ? CurrencyAmount.nebula(slippageAdjustedAmountOut) : CurrencyAmount.ether(slippageAdjustedAmountOut);
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance, chainId) {
    ...
    if (this.tradeType === exports.TradeType.EXACT_INPUT) {
      ...
      return this.inputAmount instanceof TokenAmount ? new TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn) : chainId === exports.ChainId.FANTOM ? CurrencyAmount.fantom(slippageAdjustedAmountIn) : chainId === exports.ChainId.NEBULA ? CurrencyAmount.nebula(slippageAdjustedAmountIn) : CurrencyAmount.ether(slippageAdjustedAmountIn);
    }
  }
  /**
